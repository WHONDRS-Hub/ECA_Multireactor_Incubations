...
boye_dev <- boye %>% 
  ...
  mutate(Methods_Deviation = str_replace(Methods_Deviation.fin, "; N/A", "")) %>% 
  dplyr::select(-c(Methods_Deviation.x, Methods_Deviation.fin, MOI_1, MOI_2, MOI_3, Initial_Gravimetric_Moisture, Final_Gravimetric_Moisture))
