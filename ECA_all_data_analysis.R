...
## Effect Size PCA combined figure ####

fine_sand_image = image_read("C:/GitHub/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/2024-06-10_Cube_Median_Effect_vs_Fine_Sand_Scatter.png")
...
grav_moi_image = image_read("C:/GitHub/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/2024-06-10_Cube_Median_Effect_vs_Fin_Grav_Moi_Scatter.png")

grav_moi_label_image = image_annotate(grav_moi_image, "C", size = 65, location = "+30+20", color = "black")

grav_moi_scale_image = image_scale(grav_moi_label_image, "65%")

scatter_image = image_append(c(fine_sand_scale_image, grav_moi_scale_image), stack = TRUE)

pca_image = image_read("C:/GitHub/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/2024-06-10_Cube_Median_Effect_PCA.png")
...
image_write(pca_combine_image, path = "C:/Github/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/2024-06-10_Combined_PCA.png")
