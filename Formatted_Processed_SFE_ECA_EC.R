...
#import_iron = function(input.path){
  ...
  # import map
  ferrozine_map = read_excel("01_Rawdata/20230110_Data_Raw_SFE_ECA_EC_1-270/EC_Fe_Working_Sheet_2023.xlsx", sheet = "map") %>% mutate_all(as.character) 
...
write.csv(data_processed,"02_FormattedData/20230110_Data_Formatted_SFE_ECA_EC_1-270/20230110_Data_Formatted_SFE_ECA_EC_1-270.csv", row.names = F)
...
merged$mg_Fe_per_kg_sediment <- merged$mg_Fe_per_L*
