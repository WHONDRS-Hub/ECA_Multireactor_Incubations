...
for (i in 1:length(location)){
  ...
  for (j in 1:length(unique.incubations)){
    ...
    if (plot.toggle == TRUE) {
      ...
      #ggsave(file=paste0("C:/GitHub/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/Rates/",data_site_subset$Sample_ID[1],".pdf"), width = 7, height = 7, units = "in")
      
   #  pdf(file = paste0("C:/GitHub/ECA_Multireactor_Incubations/Physical_Manuscript_Figures/Rates/All_Fits.pdf"))
   #  
   # for(m in 1:1){
   # 
   #   print(multi)
...
rename(Material = Material.x)

output.path = paste0("C:/Users/",pnnl.user,"/OneDrive - PNNL/Shared Documents - Core Richland and Sequim Lab-Field Team/Data Generation and Files/ECA/INC/03_ProcessedData/")
  

write.csv(boye_dev, paste0("C:/Users/",pnnl.user,"/OneDrive - PNNL/Shared Documents - Core Richland and Sequim Lab-Field Team/Data Generation and Files/ECA/INC/03_ProcessedData/EC_Sediment_Incubations_Respiration_Rates_ReadyForBoye_",Sys.Date(),".csv"), row.names = F)
