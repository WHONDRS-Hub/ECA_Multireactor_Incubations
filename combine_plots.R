...
setwd("C:/Users/laan208/OneDrive - PNNL/Shared Documents - Core Richland and Sequim Lab-Field Team/Data Generation and Files/ECA/INC/03_ProcessedData/Plots/EL/")
...
pdf_combine(ex_pdf, output = "EL_All_Fits.pdf")
